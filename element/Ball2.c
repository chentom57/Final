...
{     
    ...
    if(chara2 -> state2 == 0){
        ...
        //     chara2 -> state2 = 0;
        if(al_mouse_button_down(&msstate, 1)&&Gold>=200){//*mouse right button is clicked return 1
        ...
        else if(key_state[ALLEGRO_KEY_SPACE]&&Gold>=100){//*mouse right button is clicked return 1
